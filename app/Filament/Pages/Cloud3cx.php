...
class Cloud3cx extends Page
{
    protected string $view = 'filament.app.pages.cloud3cx';

    protected static string|BackedEnum|null $navigationIcon = 'heroicon-o-phone';

    protected static ?string $navigationLabel = '3CX Controlpanel';
    ...
    protected static ?string $slug = '3cx-controlpanel';
