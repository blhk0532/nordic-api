...
class Teamsale extends Page
{
    protected string $view = 'filament.app.pages.teamsale';

    protected static string|BackedEnum|null $navigationIcon = 'heroicon-o-phone';

    protected static ?string $navigationLabel = 'Teamsale CRM';
    ...
    protected static ?string $slug = 'teamsale';
