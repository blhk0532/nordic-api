...
final readonly class TransferHittaDataToRingaDataAction
{
    /**
     * Transfer selected HittaData records to RingaData table.
     *
     * @param  Collection<HittaData>  $records
     * @param  array<string, mixed>  $data
     */
    public function handle(Collection $records, array $data): void
    {
        DB::transaction(function () use ($records, $data): void {
            $records->each(function (HittaData $record) use ($data): void {
                RingaData::create([
                    ...
                    'lan' => null,
                    'adressandring' => null,
                    'telfonnummer' => $record->telefonnummer ?? $record->telefonnumer ?? null,
                    'stjarntacken' => null,
                    'fodelsedag' => null,
                    'personnummer' => null,
                    'alder' => $record->alder,
