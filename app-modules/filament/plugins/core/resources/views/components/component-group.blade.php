...
<div x-data x-disclosure {{
    ...
    <div class="flex items-center justify-between bg-gray p-4 dark:border-zinc-700 dark:bg-white/2">
    ...
    <div x-disclosure:panel x-collapse class="flex flex-col divide-y bg-gray dark:bg-white/2">
