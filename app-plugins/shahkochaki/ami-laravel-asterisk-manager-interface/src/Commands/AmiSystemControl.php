...
class AmiSystemControl extends AmiAbstract
{
    ...
    public function client(Client $client)
    {
        ...
        if ($request) {
            $this->dispatcher->dispatch('ami.system.operation.sent', [$this, $operation, $request]);

            $request->then(
                function (Response $response) use ($operation) {
                    $this->dispatcher->dispatch('ami.system.operation.completed', [$this, $operation, $response]);
