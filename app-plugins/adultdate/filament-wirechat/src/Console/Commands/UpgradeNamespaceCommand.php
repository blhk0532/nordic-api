...
class UpgradeNamespaceCommand extends Command
{
    ...
    protected $description = 'Upgrade Wirechat namespace from Namu\WireChat to Adultdate\Wirechat';
    ...
    public function handle()
    {
        ...
        $basePath = base_path();
        $files = [];
        $isWindows = mb_strtoupper(PHP_OS) === 'WINNT' || mb_strtoupper(PHP_OS) === 'WIN32';
        $sedFlag = $isWindows ? '' : (mb_strtoupper(PHP_OS) === 'DARWIN' ? "''" : '');
