...
<header class="px-3 z-10 sticky top-0 w-full py-2" dusk="header">
    ...
    <section class=" justify-between flex items-center p-4">
        ...
        <div class="flex gap-x-3 items-center  ">
            ...
            <x-wirechat::actions.new-chat widget="{{$this->isWidget()}}" panel="{{ is_string($this->panel) ? $this->panel : ($this->panel()?->getId() ?? '') }}" >
...
<style>
    ...
    @if ($chatsSearch)
        <section class="mt-4">
            <div style="margin-top: -66px; margin-right: 120px;  margin-left: 12px;" class="px-2 py-3 rounded-lg dark:bg-[var(--wc-dark-secondary)]  bg-[var(--wc-light-secondary)]  grid grid-cols-12 items-center">
