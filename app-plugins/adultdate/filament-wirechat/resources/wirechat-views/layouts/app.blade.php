...
@php
    ...
    $title = $currentPanel->getHeading()?? config('app.name', 'Nordic Digital Solutions');
@endphp
<head>
    <meta charset="utf-8">
...
<body  x-data x-cloak class="font-sans antialiased">
    ...
    @livewire('wirechat.modal', [], key('wirechat-modal'))
    @livewireScripts
    @wirechatAssets($panel ?? null)
