...
class FilamentFailedJobsPlugin implements Plugin
{
    ...
    public function usingHorizon(bool $horizon = true): self
    {
    ...
    public function hideConnectionOnIndex(bool $hideConnectionOnIndex = true): self
    {
    ...
    public function hideQueueOnIndex(bool $hideQueueOnIndex = true): self
    {
