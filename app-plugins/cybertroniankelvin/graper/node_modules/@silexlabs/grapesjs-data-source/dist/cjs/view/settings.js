...
class DataSourceCard extends lit_1.LitElement {
    ...
    render() {
        ...
        const isGraphQL = this.dataSource instanceof GraphQL_1.default;
        const backendType = isGraphQL ? this.dataSource.backendType : null;
      ...
      <div class="ds-card" @click=${() => this.dispatchEvent(new CustomEvent('edit', { detail: this.dataSource }))}>
        ...
        <div class="ds-card__actions">
          <button
            class="ds-card__btn"
            @click=${(e) => { e.stopPropagation(); this.dispatchEvent(new CustomEvent('test', { detail: this.dataSource })); }}
            ?disabled=${this.isTestingConnection}
          >
            ${this.isTestingConnection ? 'Testing...' : 'Test'}
          </button>
          ${this.dataSource.readonly !== false ? '' : (0, lit_1.html) `
            <button
...
__decorate([
    (0, decorators_js_1.property)({ type: Object }),
    __metadata("design:type", Object)
], DataSourceCard.prototype, "dataSource", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: Boolean }),
    __metadata("design:type", Boolean)
], DataSourceCard.prototype, "isTestingConnection", void 0);
if (!customElements.get('ds-data-source-card')) {
    customElements.define('ds-data-source-card', DataSourceCard);
}
class SettingsHeaders extends lit_1.LitElement {
    constructor() {
        super();
        this.headers = {};
        this.readonly = false;
      ...
      ${this.readonly ? '' : (0, lit_1.html) `
        <button
          ...
          @click=${() => {
            ...
            // Add the header
            this.headers = Object.assign(Object.assign({}, this.headers), { [name]: value });
            this.dispatchEvent(new CustomEvent('change'));
        }}
        >Add a header</button>
      `}
      <ul>
        ${Object.entries(this.headers).map(([name, value]) => (0, lit_1.html) `
          <li>
            <label class="ds-field">
              <span>Name</span>
              <input
...
__decorate([
    (0, decorators_js_1.property)({ type: Array }),
    __metadata("design:type", Object)
], SettingsHeaders.prototype, "headers", void 0);
__decorate([
    (0, decorators_js_1.property)({ type: Boolean }),
    __metadata("design:type", Boolean)
], SettingsHeaders.prototype, "readonly", void 0);
